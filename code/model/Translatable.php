 ...
 */
class Translatable extends DataExtension implements PermissionProvider, LocaleProvider, LocaleStore {
	 ...
	 * Turn this on to handle language settings via urlsegment rewriting e.g. /home becomes /home-en-nz
	 */
	...
	/**
	 * Choose the locale the site is currently on.
	 *
	...
	/**
	 * Get the default locale from the LocaleProviderDefault locale provider
     *
	...
	static function default_locale() {
		return LocaleProviderDefault::get_locale();
	}

	/**
	 * Set default locale. Please set this value *before* creating
	...
	static function set_default_locale($locale) {
        LocaleProviderDefault::set_locale($locale);
	}
	...
	static function set_locale($locale) {
        return AbstractLocaleProvider::set_locale($locale);
	}
